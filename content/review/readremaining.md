...
- {{< emoji ":white_square_button:" >}} Add tests ([Pull #5](https://github.com/Aerolab/readremaining.js/pull/5))
- {{< emoji ":white_square_button:" >}} Add eslint, and style code according to it ([Pull #6](https://github.com/Aerolab/readremaining.js/pull/6))
